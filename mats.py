#/home/nvidia/Documents/Quanser/libraries/python/hal/products
import numpy as np
...
class SDCSRoadMap(RoadMap):
    ...
    def __init__(self, leftHandTraffic=False, useSmallMap=False):
        ...
        # useful constants
        scale = 0.002035 #0.002035, little smaller = 0.00198
        xOffset = 1184 #1134, 1100 = too far right, 1164 
        yOffset = 2423 #2363 little not much = 2373, 2473 = big change but too wide, 2448 = too wide
        #2453 = almost good but little wide, 2423

        innerLaneRadius = 305.5 * scale
        outerLaneRadius = 438 * scale       #438
